                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul id="groupList" class="nav navbar-nav">
                            ...
                            <li><button type="button" onclick="window.location.href = '/add_json?id=${groupId}';" class="btn btn-default navbar-btn">Add JSON</button></li>
                            ...
                            <c:if test="${groupId > 0}" >
                                <li><button type="button" onclick="window.location.href = '/group/delete/${groupId}';" class="btn btn-default navbar-btn">Delete Group</button></li>
                            </c:if>
